---
title: "Homework 03 - Take a sad plot and make it better"
output: 
  tufte::tufte_html:
    css: ./hw.css
...
We do the wide to long conversion using the function `pivot_longer()`.
...
To submit, you need to export your .html document from RStudio Cloud and then upload it to the HW 03 assignment on Canvas. Refer back to [Lab 01](https://kgfitzgerald.github.io/APU_MATH_250/labs/lab-01-hello-r.html) for detailed instructions on how to export and submit your assignment. 
