...
7. Use a `pivot_longer` to pivot the columns `Mac:PC`. Consider using `names_to = "laptop_type"` and `values_to = "laptop_access"` to name the new pivoted columns. Then, recreate the following visualization.
