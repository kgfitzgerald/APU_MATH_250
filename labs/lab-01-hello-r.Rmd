...
+ Open `lab-01.Rmd` by clicking on the file name in the Files pane (bottom right quadrant)

The document you are currently reading has all the instructions for Lab 01, but you will complete the lab by adding code and text responses to the `lab-01.Rmd` document in RStudio Cloud.
...
In the R Markdown (Rmd) file in your project, change the author name to your name, and knit the document.
...
🧶 ✅ *This is a good place to pause and Knit to make sure there are no errors in your .Rmd*
...
🧶 ✅ ⬆️ *Yay, you're done! Knit one last time, and verify that everything is displayed correctly in your lab-01.html file. To view the .html, click on the file name in the Files quadrant, and select "View in Web Browser". If everything looks good, you're ready to submit!*
