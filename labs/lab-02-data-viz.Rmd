...
+ In Canvas, navigate to ["RStudio Cloud Links"](https://canvas.apu.edu/courses/42480/pages/rstudio-cloud-links) and click the link to join your group specific `MATH_250 Lab 02 G#` workspace. 
+ In the workspace, click on `MATH_250_Lab_02` to launch the project
...
7. Explore the same question as in Exercise 6, this time using `geom_density_ridge()` to construct a ridge plot as an alternative to side-by-side box plots.  
...
10. Again make a scatterplot to explore the relationship between education and views of scientists, but this time facet by whether the person hunted or fished in the past year. 
...
11. What is an additional question you could investigate using this data? State the question, provide a visualization that investigates it, and comment on what your visualization shows. 

12. Write a brief paragraph summarizing what you found in this lab, what limitations might exist to the data/analyses, and what additional data you would like to have to explore further questions. 

# Submission

To submit, you need to export your .html document from RStudio Cloud and then upload it to the Lab 02 assignment on Canvas. Refer back to [Lab 01](https://kgfitzgerald.github.io/APU_MATH_250/labs/lab-01-hello-r.html) for detailed instructions on how to export and submit your assignment. Recall only one group member needs to submit the assignment.
