...
This lab will be completed collaboratively in your randomly assigned Labs 03 - 04 groups (see Canvas). Choose a *different* group leader this week (e.g. not the same person that was randomly assigned as the leader in Canvas last week).

+ Login to your RStudio Cloud account
+ Navigate to the `MATH_250 Labs 03 - 04 G#` workspace 
