...
Try to come up with research questions that fit into each of the 6 categories on the previous slide (Descriptive, Exploratory, Inferential, Predictive, Causal, Mechanistic). 
...
+ Brainstorm topic(s) of common interest
+ Browse [data sources](https://apumath250.netlify.app/project/#data-sources) on course website
+ Locate a dataset
+ Determine a research question that could be answered with that data
