...
- Lab 01 (from last Thursday) due TONIGHT (Tuesday), 11:59pm
- AE 02 (in-class today) due Thursday by class time (4:20pm)
- First 2 [Statistics Experience points](https://kgfitzgerald.github.io/APU_MATH_250/hw/se-01.html) due September 22
...
*Will the quiz always be as technical as it was this week?*

+ The prep quiz from Week 1 is pretty typical. Main goal is to help you keep track of the new R functions/terminology introduced each week. Quizzes are open note, open internet. 

*I'm not sure if this would be necessarily helpful, but I think it would be nice if the series of videos were combined into one video. Opening up a bunch of new tabs can get a little overwhelming.*

+ Thanks for the feedback. Plan to keep them as separate videos for this semester (mostly for logistical purposes on my end), but if others feel similarly, let me know and I can make the change for the future! 
