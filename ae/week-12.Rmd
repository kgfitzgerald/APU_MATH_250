...
-   THIS WEEK
    ...
    -   Rough drafts due TONIGHT! Upload .zip to Google Drive

    -   BEFORE CLASS THURSDAY: Read two assigned rough drafts (this replaces annotations this week)

-   WEEK 13 (AFTER THANKSGIVING)

    -   For Tuesday class-time: Annotations 10 / Prep Week 13 (\~30 mins of YouTube videos)

    -   Due Tuesday 11:59pm: Formal Peer Review due (recommend getting this done before Thanksgiving - will start in class this Thursday)

    -   For Thursday class-time: Prep Quiz 13 (10 min lecture, then 3 short Prep Activities with Shiny Apps)

    -   Any last stats experience points (5 total for semester) due Thursday after thanksgiving (was originally this Thursday)

|         | Tue in-class                         | Thur in-class                                |
|---------|--------------------------------------|----------------------------------------------|
| Week 12 | Communicating Results Part 1 (no AE) | Peer review                                  |
| Week 13 | Communicating Results Part 2 (no AE) | Shiny Apps (Lab 09)                          |
